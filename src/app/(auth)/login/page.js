  ...
  return (
    <AuthCard>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <input type='text' inputMode='numeric' ref={mobileInputRef} onInput={(e) => e.currentTarget.value.length === 10? setCanSubmit(true): setCanSubmit(false) } placeholder='+91' className='w-[22rem] rounded-md bg-input px-3 py-2 focus:outline-1 focus:outline-gray-300' />
      </div>
